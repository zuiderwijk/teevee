...
- exact production metrics, responsive rules and physical acceptance criteria are defined by `docs/TOTAAL_VISUAL_CONVERGENCE.md` once that owner-reviewed specification is merged.
