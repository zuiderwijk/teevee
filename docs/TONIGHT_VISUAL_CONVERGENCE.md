...
Do not add:
- a `populaire zenders / alle zenders` toggle, channel-scope filter or equivalent control on Films, Series or Sport; channel eligibility is product logic, not carousel chrome;
- `Uitgelicht`;
- `Verder vanavond`;
