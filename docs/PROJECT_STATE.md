...
**PR #127 is the active visible Guide implementation increment.** Its approved signal ownership remains intact. The current PR branch implements all three focused corrections opened by owner physical review of `aa5c947f5d9e44089a33cb4d5ae71d5a6b916ffd`: (1) Nu & Straks channel identity bottom-aligns with the already bottom-aligned reference programme without changing row/reference geometry; (2) editorial persistence preserves a started broadcast's Kijktip while its canonical programme remains retained, while future omissions remain retractable and orphaned signals are cleaned; and (3) Per-zender keeps X24 time-text ownership while compacting the surface to 5-pt padding/X19/min-width48 with unchanged time/Kijktip text positions and row formulas. Totaal, Programme Detail, 06:00/DST/horizon semantics and Guide gesture ownership remain unchanged. **Next gate: Lead exact-head review, then focused owner physical iPhone recheck; physical acceptance is not yet granted.**
