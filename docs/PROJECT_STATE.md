...
- **Active 49-channel expansion:** Issue #175 / PR #176 implements the exact owner-approved 49-channel set/order, explicit 36 NL + 13 BE provider ownership, 12-day bounded multi-source refresh planning, deterministic 12→49 personalisation reconciliation and local 49/49 PNG logos. The branch is being reconciled onto merged #173 / canonical `main`; production activation remains gated by exact-head CI, source-specific hosted NL/BE capacity evidence, physical iPhone 49-channel/logo validation and Independent QA.
