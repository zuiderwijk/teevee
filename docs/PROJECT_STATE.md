...
- Relevant durable architecture contracts are ADR 0001 through ADR 0011; ADR 0010 is canonical for the classification sibling boundary and ADR 0011 is canonical for the broadcast-keyed external-content identity lifecycle.
