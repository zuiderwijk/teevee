 ...
 * Presentation eligibility is derived only from the already-bounded programme window so
 * a long repeated run is mounted only while at least one member intersects that window.
 */
