...
const edgeEntrypoint = resolve(repoRoot, 'supabase/functions/epg-refresh/index.mjs');
...
describe('epg-refresh Edge runtime module graph', () => {
  it('uses explicit self-resolving runtime imports so the deployed function can boot without tsconfig/sloppy resolution', () => {
